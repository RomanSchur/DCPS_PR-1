#* тест отримання показників з заниженими нічними показниками
import unittest
import copy
...
class test1_pr2(unittest.TestCase):
   def test(self):
        ...
        new_data = {"ID": 1, "Дата": "02.03.2025", "Денне_споживання(кВт)": 50.0, "Нічне_споживання(кВт)": 5, "Загальна сума оплати на теперішню дату": 0}
        ...
        self.assertEqual(updated_data["Нічне_споживання(кВт)"], 85)
        self.assertEqual(updated_data["Загальна сума оплати на теперішню дату"], 3156)
